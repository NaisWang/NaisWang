...
- 主谓结构, 例如：The birds fly.
- 主谓宾结构, 例如：We clean the classroom
- 主谓补结构（主系表结构），例如: The food tastes delicious.
- 主谓宾宾结构, 例如：I give the book to her.
- 主谓宾补结构, 例如：I made John our chairman.
...
英语可以分为三大类复合句，分别是名词性从句、形容词性从句、副词性从句
